...
Matrix BasicMatrixMultiplication(const std::vector<double>& A,
...
/* Вспомогательные функции Strassen

void splitMatrix(int size, const std::vector<double>& a,
...
void assembleMatrix(int size, const std::vector<double>& a,
                    std::vector<double>& a11, std::vector<double>& a12,
                    std::vector<double>& a21, std::vector<double>& a22) {
  int fSize = size / 2;
  for (int i = 0; i < fSize; i++) {
